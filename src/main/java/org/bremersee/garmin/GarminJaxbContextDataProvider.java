...
public class GarminJaxbContextDataProvider implements JaxbContextDataProvider {
  ...
  /**
   * The constant ACCELERATION_EXT_V1_NS.
   */
  public static final String ACCELERATION_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/AccelerationExtension/v1";

  /**
   * The constant ACTIVE_ITEM_EXT_V1_NS.
   */
  public static final String ACTIVE_ITEM_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/ActiveItemExtensions/v1";

  /**
   * The constant ACTIVITY_EXT_V1_NS.
   */
  public static final String ACTIVITY_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/ActivityExtension/v1";

  /**
   * The constant ACTIVITY_EXT_V2_NS.
   */
  public static final String ACTIVITY_EXT_V2_NS
      = "http://www.garmin.com/xmlschemas/ActivityExtension/v1";

  /**
   * The constant ACTIVITY_GOALS_EXT_V1_NS.
   */
  public static final String ACTIVITY_GOALS_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/ActivityGoals/v1";

  /**
   * The constant ADVENTURES_EXT_V1_NS.
   */
  public static final String ADVENTURES_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/AdventuresExtensions/v1";

  /**
   * The constant CALORIE_BURN_DATA_V1_NS.
   */
  public static final String CALORIE_BURN_DATA_V1_NS
      = "http://www.garmin.com/xmlschemas/CalorieBurnData/v1";

  /**
   * The constant CLIENT_PROFILE_V1_NS.
   */
  public static final String CLIENT_PROFILE_V1_NS
      = "http://www.garmin.com/xmlschemas/ClientProfile/v1";

  /**
   * The constant CONVERTER_PLUGIN_V1_NS.
   */
  public static final String CONVERTER_PLUGIN_V1_NS
      = "http://www.garmin.com/xmlschemas/ConverterPlugin/v1";

  /**
   * The constant COURSE_EXT_V1_NS.
   */
  public static final String COURSE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/CourseExtension/v1";

  /**
   * The constant CREATION_TIME_EXT_V1_NS.
   */
  public static final String CREATION_TIME_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/CreationTimeExtension/v1";

  /**
   * The constant DATA_TYPE_LOCATION_EXT_V1_NS.
   */
  public static final String DATA_TYPE_LOCATION_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/GarminDeviceExtensions/DataTypeLocation/v1";

  /**
   * The constant DEVICE_DOWNLOAD_V1_NS.
   */
  public static final String DEVICE_DOWNLOAD_V1_NS
      = "http://www.garmin.com/xmlschemas/DeviceDownload/v1";

  /**
   * The constant DIRECTORY_LISTING_V1_NS.
   */
  public static final String DIRECTORY_LISTING_V1_NS
      = "http://www.garmin.com/xmlschemas/DirectoryListing/v1";

  /**
   * The constant EULA_V1_NS.
   */
  public static final String EULA_V1_NS = "http://www.garmin.com/xmlschemas/Eula/v1";

  /**
   * The constant FAT_CALORIE_EXT_V1_NS.
   */
  public static final String FAT_CALORIE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/FatCalories/v1";

  /**
   * The constant FITNESS_DEVICE_LIMITS_V1_NS.
   */
  public static final String FITNESS_DEVICE_LIMITS_V1_NS
      = "http://www.garmin.com/xmlschemas/FitnessDeviceLimits/v1";

  /**
   * The constant FLIGHT_PLAN_V1_NS.
   */
  public static final String FLIGHT_PLAN_V1_NS = "http://www8.garmin.com/xmlschemas/FlightPlan/v1";

  /**
   * The constant FORERUNNER_LOGBOOK_V1_NS.
   */
  public static final String FORERUNNER_LOGBOOK_V1_NS
      = "http://www.garmin.com/xmlschemas/ForerunnerLogbook";

  /**
   * The constant GARMIN_DEVICE_EXT_V1_NS.
   */
  public static final String GARMIN_DEVICE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/GarminDeviceExtensions/v1";

  /**
   * The constant GARMIN_DEVICE_EXT_V2_NS.
   */
  public static final String GARMIN_DEVICE_EXT_V2_NS
      = "http://www.garmin.com/xmlschemas/GarminDeviceExtensions/v2";

  /**
   * The constant GARMIN_DEVICE_V1_NS.
   */
  public static final String GARMIN_DEVICE_V1_NS
      = "http://www.garmin.com/xmlschemas/GarminDevice/v1";

  /**
   * The constant GARMIN_DEVICE_V2_NS.
   */
  public static final String GARMIN_DEVICE_V2_NS
      = "http://www.garmin.com/xmlschemas/GarminDevice/v2";

  /**
   * The constant GARMIN_MOBILE_APP_PATH_EXT_V1_NS.
   */
  public static final String GARMIN_MOBILE_APP_PATH_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/GarminMobileAppPathExtension/v1";

  /**
   * The constant GARMIN_OEM_DEVICE_EXT_V1_NS.
   */
  public static final String GARMIN_OEM_DEVICE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/GarminOEMDeviceExtensions/v1";

  /**
   * The constant GARMIN_TEXT_TRANSLATION_V1_NS.
   */
  public static final String GARMIN_TEXT_TRANSLATION_V1_NS
      = "http://www.garmin.com/xmlschemas/GarminTextTranslation/v1";
  ...
  /**
   * The constant GPX_EXT_V1_NS.
   */
  public static final String GPX_EXT_V1_NS = "http://www.garmin.com/xmlschemas/GpxExtensions/v1";

  /**
   * The constant GPX_EXT_V2_NS.
   */
  public static final String GPX_EXT_V2_NS = "http://www.garmin.com/xmlschemas/GpxExtensions/v2";

  /**
   * The constant GPX_EXT_V3_NS.
   */
  public static final String GPX_EXT_V3_NS = "http://www.garmin.com/xmlschemas/GpxExtensions/v3";

  /**
   * The constant HARDWARE_VERSION_EXT_V1_NS.
   */
  public static final String HARDWARE_VERSION_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/HardwareVersionExtension/v1";

  /**
   * The constant HISTORY_DATABASE_V1_NS.
   */
  public static final String HISTORY_DATABASE_V1_NS
      = "http://www.garmin.com/xmlschemas/HistoryDatabase/v1";

  /**
   * The constant IFIX_EXT_V1_NS.
   */
  public static final String IFIX_EXT_V1_NS = "http://www.garmin.com/xmlschemas/iFixExtensions/v1";

  /**
   * The constant MOBILE_EXT_V1_NS.
   */
  public static final String MOBILE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/MobileExtensions/v1";

  /**
   * The constant POWER_EXT_V1_NS.
   */
  public static final String POWER_EXT_V1_NS = "http://www.garmin.com/xmlschemas/PowerExtension/v1";

  /**
   * The constant PRESSURE_EXT_V1_NS.
   */
  public static final String PRESSURE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/PressureExtension/v1";

  /**
   * The constant TRACK_POINT_EXT_V1_NS.
   */
  public static final String TRACK_POINT_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/TrackPointExtension/v1";

  /**
   * The constant TRACK_POINT_EXT_V2_NS.
   */
  public static final String TRACK_POINT_EXT_V2_NS
      = "http://www.garmin.com/xmlschemas/TrackPointExtension/v2";

  /**
   * The constant TRACK_STATS_EXT_V1_NS.
   */
  public static final String TRACK_STATS_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/TrackStatsExtension/v1";

  /**
   * The constant TRIP_EXT_V1_NS.
   */
  public static final String TRIP_EXT_V1_NS = "http://www.garmin.com/xmlschemas/TripExtensions/v1";

  /**
   * The constant TRIP_META_DATA_EXT_V1_NS.
   */
  public static final String TRIP_META_DATA_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/TripMetaDataExtensions/v1";

  /**
   * The constant USER_ACCOUNTS_EXT_V1_NS.
   */
  public static final String USER_ACCOUNTS_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/UserAccounts/v1";

  /**
   * The constant USER_PROFILE_EXT_V1_NS.
   */
  public static final String USER_PROFILE_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/UserProfile/v1";

  /**
   * The constant USER_PROFILE_EXT_V2_NS.
   */
  public static final String USER_PROFILE_EXT_V2_NS
      = "http://www.garmin.com/xmlschemas/UserProfile/v2";

  /**
   * The constant USER_PROFILE_POWER_EXT_V1_NS.
   */
  public static final String USER_PROFILE_POWER_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/ProfileExtension/v1";

  /**
   * The constant VIA_POINT_TRANSPORTATION_MODEL_EXT_V1_NS.
   */
  public static final String VIA_POINT_TRANSPORTATION_MODEL_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/ViaPointTransportationModeExtensions/v1";

  /**
   * The constant VIDEO_EXT_V1_NS.
   */
  public static final String VIDEO_EXT_V1_NS = "http://www.garmin.com/xmlschemas/VideoExtension/v1";

  /**
   * The constant WAYPOINT_EXT_V1_NS.
   */
  public static final String WAYPOINT_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/WaypointExtension/v1";

  /**
   * The constant WEB_LINK_EXT_V1_NS.
   */
  public static final String WEB_LINK_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/WebLinkExtensions/v1";

  /**
   * The constant WORKOUT_DATABASE_V1_NS.
   */
  public static final String WORKOUT_DATABASE_V1_NS
      = "http://www.garmin.com/xmlschemas/WorkoutDatabase/v1";

  /**
   * The constant WORKOUT_EXT_V1_NS.
   */
  public static final String WORKOUT_EXT_V1_NS
      = "http://www.garmin.com/xmlschemas/WorkoutExtension/v1";
